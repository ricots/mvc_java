 ...
 * @author ACER
 */
public class form_dosen extends javax.swing.JFrame {
    public DefaultTableModel tblmodel;
    String header[] ={"id_dosen", "nama"};
    /**
     * Creates new form form_dosen
     */
    public form_dosen() throws SQLException{
        initComponents();
        tblmodel = new DefaultTableModel(null, header);
        tabel.setModel(tblmodel);
        tabel.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        model.Tampil_dosen(this);
        setLebarKolom();
    }
    ...
    public void setColomnWidth(int kolom)
  {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_dosen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              try {                                           //
                    new form_dosen().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(form_dosen.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
